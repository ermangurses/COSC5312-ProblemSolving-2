...
* Purpose:    The purpose is that implementation of three different sort 
			  ...
			  move operations. After that, It prompts user how many comparisons
...
void distribute(int bubbleSortArray[], int insertionSortArray[], int selectionSortArray[], int SIZE);
...
* Pre-condition	: All 700  data is assigned to bubbleSortArray.
*
* Post-condition: bubbleSortArray is sorted. comparisonCounter and moveCounter
